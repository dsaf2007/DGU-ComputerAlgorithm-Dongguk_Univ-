...
public:
	...
	int retrieveLeft(KF searchKey, TE& searchElement) const;
	int retrieveRight(KF searchKey, TE& searchElement) const;
	// Retrieve element
...
private:
	...
	int retrieveLeftSub(BSTreeNode<TE, KF>* p, KF searchKey,
		TE& searchElement) const;
	int retrieveRightSub(BSTreeNode<TE, KF>* p, KF searchKey,
		TE& searchElement) const;
